export default function SubscriptionCard({name, illustration, text, price, setTogglekeyModal}) {
    return <div className="border border-couleur1 p-4 rounded-lg w-80 flex flex-col items-center m-2 box-border">
        ...
        <button onClick={()=>setTogglekeyModal(true)} className="bg-couleur6 text-couleur3 py-2 px-6 rounded cursor-pointer"> {price}</button>
    </div>
}