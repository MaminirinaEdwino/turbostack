...
export default function AddChild({block, addChild}) {
    return <div className="relative group/add">
        ...
        <div className="absolute right-0 bottom-full mb-2 hidden group-hover/add:flex flex-col bg-white dark:bg-gray-800 border border-couleur1/10 shadow-xl rounded-xl p-1 z-100 min-w-32 animate-in fade-in zoom-in-95 duration-200 h-50 -top-50 overflow-scroll">
