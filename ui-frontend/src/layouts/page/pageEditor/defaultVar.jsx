...
export const STYLE_CONTROLS = [
    ...
    { conditions: [], label: "background-color", prop: "background-color", type: "color", group: "background" },
    ...
    { conditions: [], label: "Arrondi", prop: "border-radius", type: "number", placeholder: "e.g. 8", unite: ["px", "em", "rem", "cm", "%"], group: "border" },
    { conditions: [], group: "sizing", label: "Width", prop: "width", type: "number", placeholder: "100", unite: ["px", "em", "rem", "cm", "%"] },
    { conditions: [], group: "sizing", label: "Height", prop: "height", type: "number", placeholder: "auto", unite: ["px", "em", "rem", "cm", "%"] },
    ...
    { conditions: [], group: "border", label: "border-width", prop: "border-width", type: "number", unite: ["px", "em", "rem", "cm"] },
    ...
    { conditions: [], group: "border", label: "border-top-width", prop: "border-top-width", type: "number", unite: ["px", "em", "rem", "cm"] },
    ...
    { conditions: [], group: "border", label: "border-left-width", prop: "border-left-width", type: "number", unite: ["px", "em", "rem", "cm"] },
    ...
    { conditions: [], group: "border", label: "border-right-width", prop: "border-right-width", type: "number", unite: ["px", "em", "rem", "cm"] },
    ...
    { conditions: [], group: "sizing", label: "margin-top", prop: "margin-top", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "sizing", label: "margin-bottom", prop: "margin-bottom", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "sizing", label: "margin-left", prop: "margin-left", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "sizing", label: "margin-right", prop: "margin-right", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "sizing", prop: "padding-top", label: "padding-top", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "sizing", prop: "padding-bottom", label: "padding-bottom", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "sizing", prop: "padding-left", label: "padding-left", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "sizing", prop: "padding-right", label: "padding-right", type: "number", unite: ["px", "em", "rem", "cm"] },
    ...
    { conditions: [], group: "outline", prop: "outline-offset", label: "outline-offset", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "outline", prop: "outline-width", label: "outline-width", type: "number", unite: ["px", "em", "rem", "cm"] },
    ...
    { conditions: [], group: "text", prop: "letter-spacing", label: "letter-spacing", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "text", prop: "text-indent", label: "text-indent", type: "number", unite: ["px", "em", "rem", "cm"] },
    ...
    { conditions: [], group: "position", prop: "top", label: "Top", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "position", prop: "bottom", label: "Bottom", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "position", prop: "left", label: "Left", type: "number", unite: ["px", "em", "rem", "cm"] },
    { conditions: [], group: "position", prop: "right", label: "Right", type: "number", unite: ["px", "em", "rem", "cm"] },
];
