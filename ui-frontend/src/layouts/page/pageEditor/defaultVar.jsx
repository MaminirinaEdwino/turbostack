...
export const STYLE_CONTROLS = [
    ...
    { group: "animation", label: "Animation delay", prop: "animation-delay", type: "number", unite: ["s", "ms"] },
    ...
    { group: "transition", prop: "transition-properties", label: "transition", type: "select", options: ["all", "none"] },
