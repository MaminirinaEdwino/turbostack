...
export default function NewProject() {
  ...
  const handleCreateProject = async (e) => {
    ...
    if (
      (await GoApp.createProject(
        newProjectValue.name,
        newProjectValue.description,
        newProjectValue.type,
  ...
  return (
    <MainLayout
      child={
        <div className="flex-1 p-8 overflow-y-auto dark:bg-gray-950">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mt-10">
            ...
            <form className="bg-white p-8 rounded-2xl border border-couleur1/10 shadow-xl w-full md:w-1/2 max-w-lg flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <label
                  className="text-xs font-bold text-couleur1 opacity-50 uppercase tracking-wider"
              ...
              <div className="flex flex-col gap-2">
                <label
                  className="text-xs font-bold text-couleur1 opacity-50 uppercase tracking-wider"
                  htmlFor="newProjectType"
                >
                  Project Type
                </label>
                <select
                  className="border border-couleur1/20 p-3 rounded-xl bg-couleur3/10 outline-none focus:ring-2 ring-couleur1/20 text-couleur1 transition-all appearance-none cursor-pointer"
                  name="newProjectType"
                  id="newProjectType"
                  onInput={(e) =>
                    setNewProject((newProjectValue) => ({
              ...
              <div className="flex gap-4 mt-4">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-couleur1 text-white py-3 rounded-xl hover:shadow-lg hover:bg-opacity-90 transition-all font-bold"
                >
                ...
                <button
                  ...
                  className="px-6 py-3 rounded-xl border border-couleur1 text-couleur1 font-bold hover:bg-couleur3 transition-all flex items-center gap-2"
                >
                  <X size={20} /> Cancel
                </button>
              </div>
